...
logsout_PCCTHD3 = mean(logsout3.get('THDPCCVoltageMG1').Values.Data);
logsout_LoadTHD3 =mean(logsout3.get('THDLoadVoltageMG1').Values.Data);
...
logsout_PCCTHD4 = mean(logsout4.get('THDPCCVoltageMG2').Values.Data);
logsout_LoadTHD4 =mean(logsout4.get('THDLoadVoltageMG2').Values.Data);
